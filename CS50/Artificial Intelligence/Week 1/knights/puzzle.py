...
knowledge2 = And(
    ...
    Or(And(BKnight, Or(And(AKnave, BKnight), And(AKnight, BKnave))), And(BKnave, Or(And(AKnight, BKnight), And(AKnave, BKnave))))
)
...
knowledge3 = And(
    ...
    Or(And(BKnight, And(AKnight, AKnave)), And(BKnave, AKnight))
)
